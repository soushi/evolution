...
$_lang['mce_editor_relative_urls_title'] = "Chemin d'accès aux fichiers:";
$_lang['mce_editor_relative_urls_message'] = "Cette option vous permet de définir comment gérer les chemins d'accès pour les liens internes. Note: Document relative links may not work right with friendly alias paths. Also, links might need to be changed if you move your site to a different domain or subdirectory if links are root relative or full path.";
