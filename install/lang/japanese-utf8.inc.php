...
$_lang["connection_screen_database_test_connection"] = 'ここをクリックして、データベースのテストを行なってください。（※権限がある場合は、この操作でデータベースを新規に作成できます）';
...
$_lang["installation_upgrade_advanced_note"] = 'データベース設定の変更を伴うアップデート(MySQL4→MySQL5など)が必要な場合は、こちらを選ぶとconfig.inc.phpを更新することができます。';
