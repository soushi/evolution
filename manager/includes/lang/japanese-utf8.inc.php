...
$_lang["remember_last_tab_message"] = 'タブ構成のページ(投稿画面・エレメント編集画面・グローバル設定など)において、最後に開いたタブを記憶します。「Stay mode」を選択すると「更新後に続けて編集」を実行した時と一部の管理画面でタブ選択を記憶します。';
